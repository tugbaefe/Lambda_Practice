...
public class C1_IntList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        System.out.println(esitElemenYokMu(list));
        System.out.println(sifiraEsitElemenYokMu(list));
        sonBesElemanTopla(list);
        sonBesElemenListele(list);
    }
    ...
    public static boolean esitElemenYokMu(List<Integer> l) {
    ...
    public static boolean sifiraEsitElemenYokMu(List<Integer> l) {
    ...
    public static void sonBesElemanTopla(List<Integer> l) {
        System.out.println(l.stream().limit(5).reduce(Integer::sum));
    ...
    public static void sonBesElemenListele(List<Integer> l) {
